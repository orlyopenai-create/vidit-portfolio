...
export const portfolioCompanies: Company[] = [
  ...
  // Fashion & Lifestyle
  { name: 'Wanderlooms',      slug: 'wanderlooms',      sector: 'Fashion & Lifestyle', logoPath: '/logos/wanderlooms.png',        tileBg: 'rgba(255,255,255,0.92)', entryValuation: '₹7Cr',     latestValuation: '₹12Cr',  multiple: '~1.7x' },
